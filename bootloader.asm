...
read_extra_code:
	...
	xor	bx, bx				; no offset
	mov	cx, 0x7e0			; load extra code after bootsector (read by bios)
	call	read_from_hdd
...
current_lba	dd	1			; initialize to first LBA address
...
error_msg	db	'CVOS bootloader error', 0xd, 0xa, 0
